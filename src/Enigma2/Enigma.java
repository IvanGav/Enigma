...
public class Enigma {
    /*
    This is my second version of Enigma. It stores RotorBoard instead of first rotor. Rotors are now unchanged which mimics
    their physical meaning slightly better.
     */
    String charsExtended = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ,.?!";
    ...
    public Enigma() {
        pb = new PlugBoard();
        pb.addSwap("");
        rb = new RotorBoard(26); //57
        rb.addRotor(new Rotor(rotor1));
        rb.addRotor(new Rotor(rotor2));
        rb.addRotor(new Rotor(rotor3));
        rb.setReflector(new Reflector(reflectorB));
    }
